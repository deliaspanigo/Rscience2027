...
# --- 2. JAVASCRIPT ---
js_logic <- "
var root, svg, g, treemap, zoom, i = 0, duration = 600, activeNode = null, ghostMode = false;
...
function update(source) {
  ...
  // COLOR Y TRANSPARENCIA DE NODOS
  nodeUpdate.select('circle')
      .style('fill', d => {
        if (d === activeNode || isAncestorOfActive(d)) return '#ff9100'; // Naranja selección
...
ui <- fluidPage(
  tags$head(
    ...
    tags$style(HTML("
      ...
      .btn-ghost:hover { background: #BB86FC; color: #000; box-shadow: 0 0 10px #BB86FC; }
  ...
  div(id = "tree-container",
      div(class = "internal-controls",
          ...
          div(id = "menu-content", class = "btn-stack",
              ...
              tags$button("👻 Ghost Mode (Velo)", class = "btn-custom btn-ghost", onclick = "toggleGhostMode()"),
