    ...
    column(
      ...
      navset_card_underline(
        ...
        nav_panel(
          title = "Teoría",
          icon = icon("book"),
          mod_03_00_collector01_ui_01_theory("txt_3")
        ),
        ...
        nav_panel(
          title = "Bibliografía",
          icon = icon("list-ul"),
          mod_03_00_collector01_ui_02_bibliography("txt_3")
        ),
        ...
        nav_panel(
          ...
          mod_03_00_collector01_ui_03_cite("txt_3")
        )
      )
    )
  )
...
server <- function(input, output, session) {
  ...
  mod_03_00_collector03_server_UNIVERSAL(id = "txt_3", folder_path_tool_script = folder_prueba())
}
