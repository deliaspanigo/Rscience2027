---
title: "Rscience - Anova - script05 - Descriptive Residuals"
format: 
  html:
...
model_error_var_MSE <- list_obj_script02$model_error_var_MSE
model_error_sd <- list_obj_script02$model_error_sd
```
...
save(list = vector_save_obj, file = "R_obj_env_script05_anova_descriptive_residuals.RData")
