...
```{r eval=TRUE, echo=TRUE}    
  ...
  plot_factor006
  # plot_factor006 <- plotly::plot_ly()
  # 
  # # Add traces
  # plot_factor006 <- plotly::add_trace(p = plot_factor006,
  #                                     type = "violin",
  #                                     y = my_minidataset[,var_name_rv],
  #                                     x = my_minidataset[,var_name_factor],
  #                                     showlegend = TRUE,
  ...
  #                                     points = "all",
  #                                     name = "Violinplot",
  #                                     color = my_minidataset$FACTOR,
  #                                     colors = df_table_factor_plot006$color)
  # 
  # 
  # 
  # # # # Title and settings...
  # plot_factor006 <- plotly::layout(p = plot_factor006,
  ...
  # # # Create a new plot...
  plot_factor007 <- plotly::plot_ly()
  
  
  # # # Adding errors...
  plot_factor007 <-   plotly::add_trace(p = plot_factor007,
                                        type = "scatter",
                                        mode = "markers",
  ...
  plot_factor007 <-  add_text(p = plot_factor007,
                              x = df_table_factor_plot007$level,
                              y = df_table_factor_plot007$mean,
  ...
  # # # Title and settings...
  plot_factor007 <- plotly::layout(p = plot_factor007,
