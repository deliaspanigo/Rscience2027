---
title: "Rscience - _script_modulo 02"
format: 
  html:
...
## Section 04 - Table for alpha and confidence values
...
## Section 05 - Table for selected variables and roles  
...
## Section 12 - Requeriment - Normality on residuals - Shapiro-Wilk test
...
## Section 13 - Requeriment - Homogeneity of variance from residuals - Bartlett test
...
save(list = vector_save_obj, file = "R_ENV_01_ANOVA.RData")
