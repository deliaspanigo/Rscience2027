...
load("R_obj_env_script02_anova_full_test.RData")
load("R_obj_env_script03_anova_model.RData")
load("R_obj_env_script04_anova_descriptive_rv.RData")
load("R_obj_env_script05_anova_descriptive_residuals.RData")
...
save(list = vector_save_obj, file = "R_obj_env_script06_anova_asa.RData")
