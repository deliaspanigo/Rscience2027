...
# # # # # Section 02 - Import dataset ----------------------------------------
  my_dataset <- get('mtcars') ###SECURITY_SEAL - external###
...
# El internal
# # # # # Section 02 - Import dataset ----------------------------------------
  my_dataset <- get('mtcars') ###SECURITY_SEAL - internal###
  head(x = my_dataset, n = 5)
```
...
# # # # # Section 03 - Settings ----------------------------------------------
  var_name_rv     <-  "mpg" ###SECURITY_SEAL###
  var_name_rv

  var_name_factor <- "cyl" ###SECURITY_SEAL###
  var_name_factor

  alpha_value     <-  0.05 ###SECURITY_SEAL###
  alpha_value

  vector_order_levels_new <- c("4", "6", "8") ###SECURITY_SEAL###
  vector_order_levels_new
  
  vector_color_levels_new <- c("#FF0000", "#00FF00", "#0000FF") ###SECURITY_SEAL###
