...
mod_special_asa_server <- function(id,
  ...
  moduleServer(id, function(input, output, session) {
    ...
    data_config <- reactive({
      ...
      target_dir <- file.path(base_path, "f02_quarto_proc", "f06_asa")

      # Lista fija de archivos y sus etiquetas
      list(
        list(file = "tab01_summary_anova.html", label = "Summary Anova", super = "Summary Anova"),
        list(file = "tab02_level02.html",       label = "Level02",       super = "Level02"),
        list(file = "tab03_level03.html",       label = "Level03",       super = "Level03")
