...
mod_special_shiny_output_server <- function(id,
  ...
  moduleServer(id, function(input, output, session) {
    ...
    data_config <- reactive({
      ...
      target_dir <- file.path(base_path, "f02_quarto_proc", "f05_shiny_output")

      # Lista fija de archivos y sus etiquetas
      list(
        list(file = "tab01_control.html",          label = "Control",               super = "Control"),
        list(file = "tab02_anova_and_tukey.html",  label = "Anova and Tukey",       super = "Anova and Tukey"),
        list(file = "tab03_requeriments.html",     label = "Requeriments",          super = "Requeriments"),
        list(file = "tab04_model.html",            label = "Model",                 super = "Model"),
        list(file = "tab05_descriptive_rv.html",   label = "Descriptive RV",        super = "Descriptive RV"),
        list(file = "tab06_residuals.html",        label = "Descriptive Residuals", super = "Descriptive Residuals")
