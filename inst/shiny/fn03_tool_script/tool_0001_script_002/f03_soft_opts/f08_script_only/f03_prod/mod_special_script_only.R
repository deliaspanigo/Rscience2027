...
# --- Módulo UI 1 ---
mod_special_script_only_ui <- function(id) {
  ns <- NS(id)
  tagList(span(style = "color: green;", "Este es el Módulo de Script Only - Script 002."))
}
...
mod_special_script_only_server <- function(id) {
